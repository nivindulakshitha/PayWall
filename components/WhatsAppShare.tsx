  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.98 }}
        onClick={handleShare}
        className="w-full px-6 py-4 rounded-2xl font-semibold transition-all duration-300 flex items-center justify-center gap-3 group"
        style={{
      ...
      >
        ...
        <span className="text-emerald-300 group-hover:text-emerald-200 text-sm font-semibold transition-colors">
          {t('buttons.shareWhatsApp')}
        </span>
      </motion.button>

      <p className="text-center text-[11px] text-gray-600">
        WhatsApp: <span className="text-gray-400 font-medium">0787124080</span>
      </p>
    </motion.div>
  )
}
